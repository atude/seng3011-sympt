export const getDiseaseImage = (diseaseName) => {
  ...
  case "hepatitis-b": return require('../assets/images/diseases/hepatitis.png');
  ...
  case "chikungunya": return require('../assets/images/diseases/malaria.png');
  ...
  case "dengue": return require('../assets/images/diseases/malaria.png');
  case "diphteria": return require('../assets/images/diseases/diphteria.png');
  case "hepatitis-a": return require('../assets/images/diseases/hepatitis.png');
  case "hepatitis-c": return require('../assets/images/diseases/hepatitis.png');
  case "hepatitis-d": return require('../assets/images/diseases/hepatitis.png');
  case "hepatitis-e": return require('../assets/images/diseases/hepatitis.png');
